...
const ProfilePage = () => {
  ...
  const [genderPreferences, setGenderPreferences] = useState(
    authUser.genderPreferences || [] // Ensure it's an array
  );
  ...
  const handleSubmit = (e) => {
    ...
    // Ensure genderPreferences is an array before submitting
    if (!Array.isArray(genderPreferences)) {
      console.error("genderPreferences must be an array");
      return;
    }
    ...
    updateProfile({
      ...
      age,
      gender,
      genderPreferences, // Send as array
      image,
    });
  };
                  ...
                  {["Male", "Female", "Both"].map((option) => (
                    <label key={option} className="inline-flex items-center">
                      <input
                        ...
                        checked={genderPreferences.includes(
                          option.toLowerCase()
                        )}
                        onChange={() => {
